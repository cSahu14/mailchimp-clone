...
export const Blog = () => {
    return (
        <div>
            ...
            <div id="back_voilet">
                <div id='voilet_child'>
                    <h1>How to Promote Your Small Business Blog</h1>
                    <p>Over 20 ways to increase traffic to your blog.</p>
                </div>
            </div>

            <div>
                <div className='first_big , all_width'>
                    <p>
                ...
                <div className='first_big , all_width'>
                    ...
                    <h3 className='mid_small_font'>
                        Prioritize search engine optimization (SEO)
                    </h3>
                    <p>SEO is a complex topic, but can be boiled down to a few steps:</p>
                    <li>Write your blog post with a single search query in mind</li>
                    <li>Include the search query in the URL and title tag of your blog post</li>
                ...
                <div className='all_width' >
                    <h1 className='mid_small_font'>Include a link to your blog within your main site navigation</h1>
                    <p className='margin_bottom'>Most websites have a menu at the top of the page which allows visitors to quickly get to different sections of the site. For example, on the Mailchimp site, there’s a link to Resources in the main menu and a dropdown menu for subsections like Marketing Tips.
                        <br />
                        Make sure you’ve included a link to your blog on the main navigation in a similar way. This makes it easy for visitors to navigate to the section of the site that most interests them, and it’s good for search too. Search engines use these links a lot like human visitors do—in order to discover the content on your site.</p>
                </div>

                <div>
                    <div className='all_width'>
                        <h1 className='big_font'>Drive visits from social media</h1>
                        <p>
                    ...
                    <div className='all_width'>
                        <h3 className='mid_small_font'>Optimize your blog posts for social media</h3>
                        <p>
                    ...
                    <div className='all_width'>
                        <h3 className='mid_small_font'>Share your posts on social media</h3>
                        <p >
